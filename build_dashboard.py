...
DIR = '/Volumes/UserData/Projects/NotebookLM_Antigravity/Meeting Prep - Technetix'
...
<head>
    ...
    <title>Meeting Prep - Technetix</title>
    <!-- Tailwind CSS -->
...
<body class="min-h-screen flex flex-col font-sans">
    ...
    <header class="glass mx-6 mt-6 p-8 rounded-xl flex flex-col md:flex-row justify-between items-center relative overflow-hidden">
        ...
        <div class="z-10 mb-6 md:mb-0">
            <h1 class="text-4xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-accent mb-2">Technetix</h1>
